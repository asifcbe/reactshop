    ...
    <div className='sign-up-container'>
      <h2>Don't have an account?</h2>
        ...
        <form onSubmit={submitHandler}>
            <FormInput label='Display Name' name='displayName' type="text" value={displayName} onChange={handleChange} />
            ...
            <FormInput label='Confirm Password' name='confirmPassword' type="password" value={confirmPassword} onChange={handleChange} />
